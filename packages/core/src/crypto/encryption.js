 ...
 */
export function deriveKeyFromPassword(password, salt, iterations = 100_000) {
    return crypto.pbkdf2Sync(password, salt, iterations, 32, 'sha256');
}
/**
 * Encrypt and sign an ExamConfiguration
 */
export function encryptAndSignExamConfiguration(config, options) {
 ...
 */
export function decryptExamConfiguration(file, password, symmetricKey) {
